    ...
    <>
      <motion.section id='aboutme' variants={parentVariants} initial="hidden" animate="visible" className='flex flex-col items-center h-fit p-5 lg:p-0'>
        ...
        <div className='flex lg:flex-row lg:w-10/12 lg:p-12 lg:pl-28 h-full'>
          ...
          <Image src={img} style={{ "borderRadius": "93% 7% 49% 51% / 57% 46% 54% 43%" }} className='hidden lg:block outline outline-[#64ffda] outline-offset-8 hover:outline-offset-[16px] duration-150 object-cover' width={400} alt='me' quality={100}>
          </Image>
